                                ...
                                <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 mb-3">
                                            <span className={`px-3 py-1 rounded-full text-xs font-bold ${batch.status === 'ongoing' ? 'bg-emerald-500/10 text-emerald-500' :
                                    ...
                                    <div className="flex flex-col gap-3 lg:w-56 shrink-0">
                                        {batch.meetingLink && batch.status === 'ongoing' && (
                                            <a
                                                ...
                                                className="flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-[#E62D26] to-[#c41e18] text-white rounded-xl font-bold text-sm shadow-lg shadow-[#E62D26]/20 hover:scale-105 transition-all"
                                            >
                                                <FiVideo size={18} />
                                                Join Live Class
                                            </a>

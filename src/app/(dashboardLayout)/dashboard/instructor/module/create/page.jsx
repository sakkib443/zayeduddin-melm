    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                router.push('/dashboard/instructor/module');
            } else {
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/instructor/module" className="p-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl transition-all">
                        <FiArrowLeft size={18} />
                    </Link>
                ...
                <button
                    ...
                    disabled={loading}
                    className="flex items-center gap-2 bg-gradient-to-r from-[#021E14] to-[#01140D] hover:from-[#01140D] hover:to-[#01140D] text-white px-5 py-2.5 rounded-xl font-semibold text-sm shadow-lg shadow-[#021E14]/25 transition-all disabled:opacity-50"
                >
                    <FiSave size={16} />
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm space-y-5">
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#021E14] to-[#01140D] text-white font-semibold text-sm hover:shadow-lg hover:shadow-[#021E14]/25 transition-all disabled:opacity-50"
                    >
                        <FiSave size={16} />
                        {loading ? 'Creating...' : 'Create Module'}
                    </button>
            ...
            {/* Info Card */}
            <div className="bg-gradient-to-r from-amber-50 to-[#01140D] p-5 rounded-2xl border border-amber-100">
                <div className="flex items-start gap-4">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#D4AF37] to-[#01140D] flex items-center justify-center text-white shrink-0 shadow-lg shadow-[#D4AF37]/25">
                        <FiLayers size={20} />
                    </div>
                    <div>

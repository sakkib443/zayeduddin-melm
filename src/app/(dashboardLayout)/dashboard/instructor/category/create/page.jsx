    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                router.push('/dashboard/instructor/category');
            } else {
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                        <Link href="/dashboard/instructor/category" className="p-3.5 bg-white border border-slate-200 rounded-2xl text-slate-500 hover:text-slate-800 hover:border-slate-300 transition-all shadow-sm">
                            <FiArrowLeft size={20} />
                        </Link>
                        <div>

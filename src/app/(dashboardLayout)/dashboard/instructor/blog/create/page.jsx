        ...
        <div className="space-y-6 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/instructor/blog" className={`p-2 rounded-lg transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-400' : 'hover:bg-slate-100 text-slate-500'}`}>
                        <FiArrowLeft size={20} />
                    </Link>
                    <div>
                ...
                <div className="flex gap-3">
                    ...
                    <button onClick={() => handleSubmit('published')} disabled={loading} className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#021E14] to-cyan-500 text-white font-semibold shadow-lg disabled:opacity-50">

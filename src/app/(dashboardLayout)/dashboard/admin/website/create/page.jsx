        ...
        <div className="max-w-6xl mx-auto space-y-8 pb-10">
            ...
            <form className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className={labelClass}>
                                        Target Platform
                                        {fetchingCategories && <FiLoader className="ml-2 animate-spin inline text-[#021E14]" size={12} />}
                                    </label>
                                ...
                                <div>
                                    ...
                                    {!fetchingCategories && categories.length === 0 && (
                                        <p className="text-[#D4AF37] text-[10px] mt-1 italic font-medium">No website categories found. Create some in Category Settings.</p>
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                < div className="lg:col-span-4 space-y-8 sticky top-24" >
                    ...
                    {/* Quick Tips */}
                    <div className="flex items-start gap-3 p-4 bg-[#021E14]/5 border border-[#021E14]/10 rounded-2xl">
                        <FiZap className="text-[#021E14] shrink-0 mt-0.5" />

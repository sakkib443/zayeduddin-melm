...
export const metadata = {
  title: {
    template: "Zayed Uddin | %s",
    default: "Zayed Uddin | Home",
  },
  description:
    "Zayed Uddin - A premium IT training and creative platform dedicated to empowering individuals with industry-leading skills in design, development, and digital arts.",
  icons: {
  ...
  other: {
    "facebook-domain-verification": "ggslw6vyjlou5i6j6iqmhxwcy21fgu",
  },
};

...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#020202]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            >
              ...
              <div className="flex flex-wrap gap-6">
                <Link href="/courses">
                  <button className="px-8 py-4 bg-[#300000] text-white rounded-full font-bold shadow-2xl shadow-[#300000]/20 hover:bg-[#4a0000] transition-all flex items-center gap-3 group">
            ...
            >
              <div className="relative grid grid-cols-2 gap-4 h-[500px]">
                ...
                <div className="flex flex-col justify-center">
                  <div className="h-[75%] rounded-[40px] overflow-hidden shadow-2xl border-4 border-[#300000]/10 relative">
                    <Image
              ...
              {/* Decorative Elements */}
              <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-[#300000]/5 dark:bg-[#D4AF37]/5 rounded-full blur-3xl -z-10" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#300000]/5 rounded-full blur-[100px] -z-10 animate-pulse" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      {/* Mission Section */}
      <section className="py-32 relative bg-[#300000] overflow-hidden">
                ...
                {[
                  ...
                  <div key={i} className="flex gap-4 p-6 bg-white/5 rounded-3xl border border-white/5">
                    <div className="w-12 h-12 bg-[#D4AF37] rounded-xl flex items-center justify-center shrink-0">
                      <item.icon className="text-[#300000]" size={20} />
                    </div>
                    <div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <motion.div
                ...
                className="p-10 bg-slate-50 dark:bg-white/5 rounded-[48px] border border-transparent hover:border-[#300000]/10 dark:hover:border-[#D4AF37]/20 transition-all duration-500 group text-center"
              >
                <div className="w-20 h-20 bg-white dark:bg-[#020202] rounded-[28px] flex items-center justify-center mb-8 mx-auto shadow-xl group-hover:bg-[#300000] dark:group-hover:bg-[#D4AF37] transition-all duration-500">
                  <item.icon className="text-[#300000] dark:text-[#D4AF37] group-hover:text-white dark:group-hover:text-[#300000]" size={32} />
                </div>
        ...
        <div className="bg-[#300000] rounded-[60px] p-12 lg:p-24 text-center relative overflow-hidden shadow-[0_40px_100px_rgba(48,0,0,0.3)]">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href="/courses">
                <button className="px-12 py-5 bg-[#D4AF37] text-[#300000] rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-2xl">

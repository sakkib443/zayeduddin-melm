                ...
                <div className="container mx-auto px-4 lg:px-24 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <span>/</span>
                            <Link href="/software" className="hover:text-[#021E14] transition-colors">Software</Link>
                            <span>/</span>
                        ...
                        >
                            <span className="px-3 py-1 bg-gradient-to-r from-[#021E14] to-[#01140D] rounded text-white text-[11px] font-bold uppercase tracking-wider">
                        ...
                        >
                            <div className="flex items-center gap-2 bg-white px-3 py-2 rounded-md border border-gray-200">
                                ...
                                <span className="text-[#021E14] font-semibold text-sm outfit">{software.platform}</span>
                        ...
                        <div className="lg:col-span-8 space-y-6">
                            ...
                            <div className="lg:hidden bg-white dark:bg-slate-900 rounded-md border border-gray-200 dark:border-slate-800 overflow-hidden">
                                ...
                                <div className="p-5">
                                    ...
                                    <button onClick={handleBuyNow} className="w-full py-3 bg-[#021E14] text-white font-semibold rounded-md active:scale-[0.98] transition-transform">
                                        Buy Now
                                    </button>
                                </div>
                            </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex flex-wrap gap-2">
                                                            {software.technologies.map((tech, idx) => (
                                                                <span
                                                                    key={idx}
                                                                    className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded text-gray-700 font-medium text-sm hover:border-teal-300 hover:bg-[#021E14] transition-colors cursor-default"
                                                                >
                                                                    {tech}
                                                                </span>
                                                            ))}
                                                    ...
                                                    {software.requirements?.length > 0 ? (
                                                        <div className="space-y-2">
                                                            {software.requirements.map((req, idx) => (
                                                                ...
                                                                >
                                                                    <span className="w-6 h-6 rounded bg-white border border-gray-200 flex items-center justify-center text-xs font-bold text-[#021E14] outfit">
                                                                        {idx + 1}
                                                                    </span>
                                ...
                                <div className="bg-white rounded-md border border-gray-200 shadow-sm overflow-hidden">
                                    ...
                                    <div className="p-5 space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#021E14] text-xs font-semibold uppercase tracking-wide mt-1 poppins">Lifetime License</p>
                                        </div>
                                        ...
                                        <div className="space-y-2.5">
                                            <button
                                                ...
                                                className="w-full py-3 bg-[#021E14] hover:bg-[#021E14] text-white font-semibold rounded-md transition-colors flex items-center justify-center gap-2"
                                            >
                                                Buy Now <FaArrowRight size={12} />
                                            </button>
                                            <button
                                                onClick={handleAddToCart}
                                                className="w-full py-2.5 bg-white border border-gray-200 text-gray-700 font-semibold rounded-md hover:border-[#021E14] hover:text-[#021E14] transition-colors"
                                            >
                                                Add to Cart
                                            </button>
                                            {software.previewUrl && (
                                                <a
                                                    ...
                                                    target="_blank"
                                                    className="w-full py-2.5 bg-gray-50 border border-gray-200 text-gray-600 font-medium rounded-md hover:border-[#021E14] hover:text-[#021E14] transition-colors flex items-center justify-center gap-2 text-sm"
                                                >
